...
const MobileHeader = ({ isMobileHeaderOpen, handleMobileHeader }) => {
  ...
  return (
    <div className="absolute top-0 right-0 h-screen">
      <aside
        className={ `${colorMode === "dark" ? "bg-black/80" : "bg-[#F7F8FA]"} h-full w-72 z-40 fixed px-3 right-0 top-0 shadow-xl`}
      ...
      >
        <div className="pt-10">
          <HStack>
            ...
            <VStack>
              <Text fontSize="16px" fontWeight={400} textColor={colorMode === "dark"? "#f4f4f4" : "#26282C"}>
                Justin Bergson
              </Text>
